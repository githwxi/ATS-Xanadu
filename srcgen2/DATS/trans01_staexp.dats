...
L0ABLsome(lab) => lab
|
L0ABLnone(tok) => label_none()
) : label // end of [val(lab)]
//
val s1e = trans01_s0exp(tenv, s0e)
//
} (*where*)//end-of-[S0LAB(lab,teq,s0e)]
) (*case+*)//end-of-[trans01_l0s0e(tenv,ls0e)]
//
(* ****** ****** *)
//
#implfun
...
| optn_nil() =>
  optn_nil()
| optn_cons(dnt0) =>
  optn_cons(dnt1) where
  { val dnt1 = trans01_i0dnt( tenv,dnt0 ) }
