...
( lvl1
(*err-level*),d3p2) => prints("D3Perrck(",lvl1,";",d3p2,")")
//
(* ****** ****** *)
//
end (*let*) // end of [ d3pat_fprint(d3p0, out) ]
...
//
end (*let*) // end of [ d3exp_fprint(d3e0, out) ]
...
*)
//
end (*let*) // end of [f3arg_fprint(farg, out)]
...
//
end (*let*) // end of [ d3gua_fprint(dgua,out) ]
//
(* ****** ****** *)
//
#implfun
...
end (*let*) // end of [ d3gpt_fprint(dgpt,out) ]
//
#implfun
d3cls_fprint
( dcls, out ) =
...
end (*let*) // end of [ d3cls_fprint(dcls,out) ]
//
(* ****** ****** *)
(* ****** ****** *)
//
...
//
end (*let*) // end of [ timpl_fprint(dimp,out) ]
//
(* ****** ****** *)
(* ****** ****** *)
...
( lvl1
(*err-level*),d3cl) => prints("D3Cerrck(",lvl1,";",d3cl,")")
//
end (*let*) // end of [ d3ecl_fprint( dcl0, out ) ]
...
end(*let*)//end-of-[d3vardcl_fprint(dvar,out)]
//
(* ****** ****** *)
...
end(*let*)//end-of-[d3fundcl_fprint(dfun,out)]
...
end (*let*) // end-of-[d3parsed_fprint(dpar,out)]
