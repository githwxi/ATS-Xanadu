...
//
end (*let*) // end of [ d1pat_fprint( d1p , out ) ]
...
(* ****** ****** *)
//
end (*let*) // end-of-[ d1exp_fprint( d1e , out ) ]
...
|D1Cifexp(gexp,_,_,_) => prints("D1Cifexp(", "...", ")")
|D1Celsif(gexp,_,_,_) => prints("D1Celsif(", "...", ")")
//
|
...
//
end (*let*) // end of [ d1ecl_fprint( dcl , out ) ]
