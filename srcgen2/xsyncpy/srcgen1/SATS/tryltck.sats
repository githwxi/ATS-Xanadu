...
(* ****** ****** *)
fun d3gua1_tryltck: ftryltck(d3gua1)
fun d3gpt1_tryltck: ftryltck(d3gpt1)
fun d3cls1_tryltck: ftryltck(d3cls1)
(* ****** ****** *)
fun d3axp1_tryltck: ftryltck(d3axp1)
(* ****** ****** *)
fun f3arg1_tryltck: ftryltck(f3arg1)
fun f3axp1_tryltck: ftryltck(f3axp1)
(* ****** ****** *)
...
(* ****** ****** *)
fun d3cls1lst_tryltck: ftryltck(d3cls1lst)
(* ****** ****** *)
fun d3axp1lst_tryltck: ftryltck(d3axp1lst)
(* ****** ****** *)
fun f3arg1lst_tryltck: ftryltck(f3arg1lst)
fun f3axp1lst_tryltck: ftryltck(f3axp1lst)
(* ****** ****** *)
fun d3ecl1lst_tryltck: ftryltck(d3ecl1lst)
fun d3ecl1opt_tryltck: ftryltck(d3ecl1opt)
(* ****** ****** *)
(* ****** ****** *)
fun teqd3exp1_tryltck: ftryltck(teqd3exp1)
(* ****** ****** *)
(* ****** ****** *)
//
