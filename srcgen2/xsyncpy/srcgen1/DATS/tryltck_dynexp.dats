...
lvl0+1,
d3exp1(
  loc0,t3q0,D3E1pcon(tknd,lab1,dcon)))
//
endlet//end-of-[d3exp1_pcon_errck(...)]
//
(* ****** ****** *)
//
fun
...
(
  d3exp1_pcon_errck
  (loc0, t3q0, tknd, lab1, dcon))
end//let
//
end(*let*)//end-of-[f0_pcon(d3e0,err0)]
//
(* ****** ****** *)
//
fun
...
//
end(*let*)//end-of-[f0_fix1(d3e0,err0)]
//
(* ****** ****** *)
(* ****** ****** *)
//
