...
Author: Hongwei Xi
//
Sun Mar 22 11:37:41 PM EDT 2026
//
...
//
val (  ) =
xatsopt_flag$pvsadd0("--_XATS2CC_")
val (  ) =
xatsopt_flag$pvsadd0("--_SRCGEN2_XATS2CC_")
//
in//let
(
argv$loop(argv); mymain_work(argv[2]))
endlet//let//end-of-(if(length(argv) >= 3))
//
val (  ) =
if
(
...
endlet//let//end-of-(if(length(argv) <= 2))
//
endlet where
{
//
...
(*
val (  ) =
prerrsln("xats2cc_ccemit00: argv = ", argv)
*)
//
...
//
(***********************************************************************)
(* end of [ATS3/XANADU_srcgen2_xats2cc_srcgen1_UTIL_xats2cc_ccemit00.dats] *)
(***********************************************************************)
