...
Author: Hongwei Xi
(*
Sun May 17 11:49:31 AM EDT 2026
*)
...
g_print
<i0pat>
( ipat ) = i0ctgjs1(filr, ipat)
#impltmp
g_print
<i1val>
( ival ) = i1valjs1(filr, ival)
//
in//let
(
conj(b0);
...
#implfun
i1ins_js1emit
( iins, env0 ) = i1ins_xats2js(iins, env0)
*)
//
(* ****** ****** *)
(* ****** ****** *)
...
//
end(*let*)//end-of-[i1cmp_js1emit(icmp,env0)]
//
(* ****** ****** *)
(* ****** ****** *)
//
...
(* ****** ****** *)
//
end(*let*)//end-of-[i1let_js1emit(env0,ilet)]
//
(* ****** ****** *)
(* ****** ****** *)
//
...
//
}(*where*)//end-of-[fjarglst_js1emit(fjas,env0)]
//
(* ****** ****** *)
(* ****** ****** *)
//
