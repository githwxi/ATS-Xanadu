...
//
val (  ) =
xatsopt_flag$pvsadd0("--_XATS2CM_")
val (  ) =
xatsopt_flag$pvsadd0("--_SRCGEN2_XATS2CM_")
//
in//let
(
...
(*
val (  ) =
prerrsln("xats2cm_cmemit00: argv = ", argv)
*)
//
...
//
(***********************************************************************)
(* end of [ATS3/XANADU_srcgen2_xats2cm_srcgen1_UTIL_xats2cm_cmemit00.dats] *)
(***********************************************************************)
