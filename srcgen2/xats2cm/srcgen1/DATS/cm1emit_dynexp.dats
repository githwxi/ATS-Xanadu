...
end(*end*)//end-of-[ l1i1vcm1(filr,ival) ]
//
(* ****** ****** *)
(* ****** ****** *)
//
...
(i0 >= 1)
then
strnfpr(filr,", ");i1valcm1(filr, x0))
}(*where*)//end-of-[i1valcm1_list(...)]
//
(* ****** ****** *)
//
fun
...
(i0 >= 1)
then
strnfpr(filr,", ");l1i1vcm1(filr, x0))
}(*where*)//end-of-[l1i1vcm1_list(...)]
//
(* ****** ****** *)
(* ****** ****** *)
//
...
(filr,"XATSCAPP(");
d2concm1(filr,dcon);
strnfpr(filr,", [");d2ctgcm1(filr,dcon);
//
if // if
list_consq(i1vs) then strnfpr(filr,", ");
//
i1valcm1_list(filr,i1vs);strnfpr(filr,"])"))
end//let
else//else
(
if
...
strnfpr(filr,"[");i1valcm1_list(filr,i1vs);strnfpr(filr,"]");strnfpr(filr,")")
)
//
|I1INStup1
(tknd, i1vs) =>
...
xtrcdcm1(filr,tknd);strnfpr(filr,", ")
;strnfpr(filr,"[");i1valcm1_list(filr,i1vs);strnfpr(filr,"]");strnfpr(filr,")")
)
//
|I1INSrcd2
...
xtrcdcm1(filr,tknd);strnfpr(filr,", ")
;strnfpr(filr,"{");l1i1vcm1_list(filr,livs);strnfpr(filr,"}");strnfpr(filr,")")
)
//
(* ****** ****** *)
//
...
i1valcm1(filr, i1v0);strnfpr(filr, ")"))
//
(* ****** ****** *)
(* ****** ****** *)
|
...
(* ****** ****** *)
//
end(*let*) // end-of-[i1inscm1(env0,iins)]
//
(* ****** ****** *)
//
fun
...
(* ****** ****** *)
end(*let*) // end-of-[i1cmpcm1(env0,icmp)]
//
(* ****** ****** *)
(* ****** ****** *)
//
...
nindstrnfpr
(filr, nind, "return ");
i1valcm1(filr, ival);fprintln(filr)
//
end//let
...
i1valcm1(filr, i1vl);strnfpr(filr, ", ");
i1valcm1(filr, i1vr);strnfpr(filr, ")\n"))
//
(* ****** ****** *)
//
|_(*otherwise*) =>
(
nindfpr(filr, nind);i1inscm1(filr, iins);fprintln(filr))
//
(* ****** ****** *)
//
...
i1tnmcm1(filr, itnm);
strnfpr(filr, " = ");
i1inscm1(filr, iins);fprintln(filr))
//
in//let
//
case+ iins of
...
nindstrnfpr
(filr, nind, "if (");
i1valcm1(filr, itst);strnfpr(filr, "):\n"))
//
val () =
(
case+ ithn of
...
//
nindstrnfpr
(filr, nind, "except X2CMExcptn as exn:\n");
nindfpr(filr, nind+2);
i1valcm1(filr, iexn);strnfpr(filr, " = exn.args[0]\n"))
//
val () =
(
nindstrnfpr
...
i1tnmcm1(filr, itnm);strnfpr(filr, "_)");fprintln(filr)))
)
//
(* ****** ****** *)
//
...
(
nindfpr(filr, nind);
i1tnmcm1(filr, itnm);strnfpr(filr, " = ");i1inscm1(filr, iins);fprintln(filr))
//
(* ****** ****** *)
(* ****** ****** *)
//
