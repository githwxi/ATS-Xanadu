...
(filr, dcon.lctn((*void*))))
end(*let*)//end-of-[d2conpl1(env0,dcon)]
*)
//
(* ****** ****** *)
//
...
_(* else *) =>
(
strnfpr(filr, "$");xsympl1(filr, name)
)
...
(
strnfpr(filr, "$");xsympl1(filr, name);
strnfpr(filr, "_");fprint_loctn_as_stamp(filr, lctn))
end(*let*)//end-of-[f0_none()]
//
}(*where*)
end(*let*)//end-of-[d2cstpl1(env0,dcst)]
//
(* ****** ****** *)
//
#implfun
...
strnfpr(filr, "$");xsympl1(filr, name);
strnfpr(filr, "_");fprint_loctn_as_stamp(filr, lctn))
end(*let*)//end-of-[d2varpl1(env0,dvar)]
//
(* ****** ****** *)
(* ****** ****** *)
//
...
}(*where*)//end-of-[i0c00pl1(filr,c00)]
//
(* ****** ****** *)
//
#implfun
...
{
#impltmp g_print$out<>() = filr
}(*where*)//end-of-[i0f00pl1(filr,f00)]
//
(* ****** ****** *)
//
#implfun
...
//
}(*where*)//end-of-[i0s00pl1(filr,s00)]
//
(* ****** ****** *)
(* ****** ****** *)
//
...
{
#impltmp g_print$out<>() = filr
}(*where*)//end-of-[i0intpl1(filr,tint)]
//
(* ****** ****** *)
(* ****** ****** *)
//
...
{
#impltmp g_print$out<>() = filr
}(*where*)//end-of-[i0btfpl1(filr,btf0)]
//
(* ****** ****** *)
(* ****** ****** *)
//
...
(
  i0chrfpr(filr, tchr))
//HX:sharing(i0chrfpr=i1chrjs1=i1chrpl1)
//
(* ****** ****** *)
(* ****** ****** *)
//
...
(
  i0strfpr(filr, tstr))
//HX:sharing(i0strfpr=i1strjs1=i1strpl1)
*)
//
(* ****** ****** *)
(* ****** ****** *)
...
{
#impltmp g_print$out<>() = filr
}(*where*)//end-of-[i0fltpl1(filr,tflt)]
//
(* ****** ****** *)
(* ****** ****** *)
//
...
//
}(*where*)//end-of-[i1tnmpl1(filr,itnm)]
//
(* ****** ****** *)
(* ****** ****** *)
//
...
//
}(* where *)//end-of-[i0strpl1(filr,tstr)]
//
(* ****** ****** *)
(* ****** ****** *)
//
(***********************************************************************)
(* end of [ATS3/XANADU_srcgen2_xats2pl_srcgen1_DATS_pl1emit_utils0.dats] *)
(***********************************************************************)
