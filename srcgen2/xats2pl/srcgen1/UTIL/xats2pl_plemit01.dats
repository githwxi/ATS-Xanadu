...
Author: Hongwei Xi
//
Sat Sep  5 07:55:59 PM EDT 2026
//
...
#if
defq(_XATS2PL_)
#typedef argv=pla1sz(strn)
#endif//#if(defq(_XATS2PL_))
//
#extern
fun
XATSOPT_argv$get
...
//
val (  ) =
xatsopt_flag$pvsadd0("--_XATS2PL_")
val (  ) =
xatsopt_flag$pvsadd0("--_SRCGEN2_XATS2PL_")
//
in//let
(
...
(*
val (  ) =
prerrsln("xats2pl_plemit01: argv = ", argv)
*)
//
...
//
(***********************************************************************)
(* end of [ATS3/XANADU_srcgen2_xats2pl_srcgen1_UTIL_xats2pl_plemit01.dats] *)
(***********************************************************************)
