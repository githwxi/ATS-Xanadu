...
(  ) =
prerrln
("d1parsed_from_fpath(\"./DATA/myfact2.dats\") =\n", dpar)
//
(* ****** ****** *)
//
val
...
let
val () =
trsym2a_at_d2parsed(dpar) in dpar
end
//
(* ****** ****** *)
//
...
val (  ) =
prerrln
("d3parsed_from_fpath(\"./DATA/myfact2.dats\") =\n", dpar)
//
(* ****** ****** *)
//
...
(* end of [ATS3/XATSOPT_TEST_JS_test26_tread23.dats] *)
