...
HX-2025-04-18:
[xsetup0.sats]
must be loaded ahead of the rest!
*)
val () =
the_prelude_load
(
...
( XATSENV
, 0(*static*)
, "srcgen1/prelude/INIT/prelude_sats.hats") *)
//
(* ****** ****** *)
(* ****** ****** *)
//
...
//
) (* end of [the_preludes_load_if(XATSENV,flag)] *)

(* ****** ****** *)
(* ****** ****** *)
//
(***********************************************************************)
(* end of [ATS3/XANADU_srcgen1_DATS_xatsopt_utils0.dats] *)
(***********************************************************************)
