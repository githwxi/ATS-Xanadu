...
}(*where*)//endof[strm_vt_forall0$f1un(...)]
//
#impltmp
< x0:vt >
...
}(*where*)//endof[strm_vt_foritm0$f1un(...)]
//
(* ****** ****** *)
(* ****** ****** *)
//
...
end//let//end-[strmcon_vt_cons(x1,xs)]
...
//
(***********************************************************************)
(* end-of-[ATS3/XANADU_srcgen1_prelude_DATS_strm000_vt.dats] *)
(***********************************************************************)
