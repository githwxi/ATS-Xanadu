...
//
#implfun
XATS2PY_lazy_f0un{a}(f0) = $lazy(f0())
#implfun
XATS2PY_llazy_f0un{a}(f0) = $llazy(f0())
#implfun
XATS2PY_lazy_vt_f0un{a}(f0) = $llazy(f0())
//
(* ****** ****** *)
//
// prelude/optn.sats
...
( case+ xs of
  | optn_nil() => f0()
  | optn_cons(x0) => f1(x0)
) (* end of [XATS2PY_optn_uncons_funs] *)
//
(* ****** ****** *)
//
// prelude/list.sats
...
//
#implfun
XATS2PY_list_nil() = list_nil((*void*))
#implfun
XATS2PY_list_cons(x0, xs) = list_cons(x0, xs)
*)
//
(* ****** ****** *)
#extern
...
//
#implfun
XATS2PY_strmcon_nil() = strmcon_nil((*void*))
#implfun
XATS2PY_strmcon_cons(x0, xs) = strmcon_cons(x0, xs)
//
(* ****** ****** *)
(*
//
...
//
#implfun
XATS2PY_strm_nil() = strm_nil((*void*))
#implfun
XATS2PY_strm_cons(x0, xs) = strm_cons(x0, xs)
//
*)
(* ****** ****** *)
#extern
...
) (* end of [XATS2PY_optn_vt_uncons_funs] *)
//
(* ****** ****** *)
//
...
//
#implfun
XATS2PY_list_vt_nil() = list_vt_nil((*void*))
#implfun
XATS2PY_list_vt_cons(x0, xs) = list_vt_cons(x0, xs)
//
(* ****** ****** *)
//
#extern
fun
XATS2PY_list_vt_uncons_funs
{x0:vt}{r0:vt}
( xs
: list_vt(x0)
, f0
...
) (* end of [XATS2PY_list_vt_uncons_funs] *)
//
(* ****** ****** *)
//
...
#extern
fun
XATS2PY_strm_vt_cons
{a:vt}
( x0: a
, xs: strm_vt(a)): strm_vt(a) = $extnam()
//
#implfun
XATS2PY_strm_vt_nil() = strm_vt_nil((*void*))
#implfun
XATS2PY_strm_vt_cons(x0, xs) = strm_vt_cons(x0, xs)
//
*)
(* ****** ****** *)
//
...
//
#implfun
XATS2PY_strmcon_vt_nil() = strmcon_vt_nil((*void*))
#implfun
XATS2PY_strmcon_vt_cons(x0, xs) = strmcon_vt_cons(x0, xs)
//
(* ****** ****** *)
//
#extern
fun
XATS2PY_strm_vt_uncons_funs
{x0:vt}{r0:vt}
( xs
: strm_vt(x0)
, f0
...
) (* end of [XATS2PY_strm_vt_uncons_funs] *)
//
(* ****** ****** *)
//
#extern
fun
XATS2PY_streax_vt_uncons_funs
{x0:vt}{r0:vt}
( xs
: streax_vt(x0)
, f1
...
) (* end of [XATS2PY_streax_vt_uncons_funs] *)
//
(* ****** ****** *)
(* ****** ****** *)
//
...
}(*where*)//end(XATS2PY_strm_vt_map0_f1un)
//
(* ****** ****** *)
//
#implfun
...
}(*where*)//end(XATS2PY_strm_vt_filter0_f1un)
//
(* ****** ****** *)
(* ****** ****** *)
//
(***********************************************************************)
(* end of [ATS3/XANADU_srcgen1_prelude_DATS_CATS_PY_basics0.dats] *)
(***********************************************************************)
