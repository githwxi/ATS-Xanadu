...
<x0:t0>
<y0:t0>
z2forcmp$tcmp(x0, y0): sint
fun
<x0:vt>
<y0:vt>
z2forcmp$tcmp0(~x0, ~y0): sint
fun
<x0:vt>
<y0:vt>
z2forcmp$tcmp1(!x0, !y0): sint
//
(* ****** ****** *)
//
fun
...
<x0:t0>
<y0:t0>
z2iforcmp$tcmp(nint,x0,y0): sint
fun
<x0:vt>
<y0:vt>
z2iforcmp$tcmp0(nint,~x0,~y0): sint
fun
<x0:vt>
<y0:vt>
z2iforcmp$tcmp1(nint,!x0,!y0): sint
//
(* ****** ****** *)
//
fun
